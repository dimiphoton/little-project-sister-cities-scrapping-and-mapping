...
> Branche de référence cible : `main` (GitHub Pages)  
> Code complet encore sur `feat/data-pipeline` — voir Phase 0 dans [PLAN.md](PLAN.md)

---

## Chronologie

### 2026 — Réorganisation Cursor

| Action | Détail |
|--------|--------|
| Docs de pilotage | `PLAN.md`, `SESSION.md`, `GUIDE_CURSOR.md` sur `main` |
| Règles IA | `.cursor/rules/projet.mdc` — contraintes auto Cursor |
| Prochaine étape | Merger `feat/data-pipeline` → `main` (Phase 0) |
